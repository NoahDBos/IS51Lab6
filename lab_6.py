...
"""
To start, we will generate a random integer between 1 and 20, and based on the
number the result of the random number, we check to see if it falls under a certain range
if the number is greater than 15, then the results will be "Cherry"
...
we iterate over using a loop three times and print the results to the user. As an example "Plum Cherry Melon"
...
if num is greater than 15
    then the results will be "Cherry"
